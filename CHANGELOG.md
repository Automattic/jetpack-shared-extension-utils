...
### Fixed
- Upgrade nudge: stop emitting an `undefined__description` class when no class name is passed to the component.
...
[2.0.14-alpha]: https://github.com/Automattic/jetpack-shared-extension-utils/compare/2.0.13...2.0.14-alpha
