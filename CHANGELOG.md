...
## [1.3.4-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Removed
- Remove no-longer-needed dependency on `lodash`.
...
[1.3.4-alpha]: https://github.com/Automattic/jetpack-shared-extension-utils/compare/1.3.3...1.3.4-alpha
