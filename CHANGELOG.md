...
### Added
- Add a new section to describe including assets from backend
...
[0.9.0-alpha]: https://github.com/Automattic/jetpack-shared-extension-utils/compare/0.8.4...0.9.0-alpha
