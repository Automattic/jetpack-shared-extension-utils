...
### Fixed
- Fix className being treated as required by TypeScript for JetpackLogo.
...
[1.4.2-alpha]: https://github.com/Automattic/jetpack-shared-extension-utils/compare/1.4.1...1.4.2-alpha
